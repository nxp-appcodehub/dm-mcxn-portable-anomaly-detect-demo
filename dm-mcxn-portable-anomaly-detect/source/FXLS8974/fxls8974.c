...
/**
 * @file fxls8974.c
 * @brief This file contains the FXLS8974CF Accelerometer driver functions.
 */
#include <FXLS8974/fxls8974.h>
#include <imu_ops.h>
#include "board.h"
...
#define MULTI_READ	1
#define I2C_MASTER_BASE (LPI2C3_BASE)
#define LPI2C_MASTER_CLOCK_FREQUENCY CLOCK_GetLPFlexCommClkFreq(3U)
