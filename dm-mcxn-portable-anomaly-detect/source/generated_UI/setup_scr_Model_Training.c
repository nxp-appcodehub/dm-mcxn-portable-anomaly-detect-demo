...
void setup_scr_Model_Training(lv_ui *ui){
	...
	lv_obj_set_style_bg_color(ui->Model_Training, lv_color_hex(0xdde4e6), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->Model_Training_labelModelTrainCurFunc, "Status Monitor");
	...
	lv_obj_set_pos(ui->Model_Training_labelModelTrainInfo, 100, 180);
	...
	lv_obj_set_pos(ui->Model_Training_labelModelTrainStat, 200, 74);
	...
	lv_obj_set_scrollbar_mode(ui->Model_Training_Cont, LV_SCROLLBAR_MODE_OFF);
	...
	lv_obj_set_size(ui->Model_Training_SliderModelTrainGamma, 480, 16);
	...
	lv_obj_set_size(ui->Model_Training_SliderModelTrainNu, 480, 16);
