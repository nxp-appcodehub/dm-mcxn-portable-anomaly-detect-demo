...
// MIKROE NATIVE PIN DEFINITIONS
#ifndef BOARD_MIKROE_NATIVE_PWM_GPIO
#define BOARD_MIKROE_NATIVE_PWM_GPIO GPIO3
#endif
#ifndef BOARD_MIKROE_NATIVE_PWM_PIN
#define BOARD_MIKROE_NATIVE_PWM_PIN 19U
#endif

#ifndef BOARD_MIKROE_NATIVE_CS_GPIO
#define BOARD_MIKROE_NATIVE_CS_GPIO GPIO3
#endif
#ifndef BOARD_MIKROE_NATIVE_CS_PIN
#define BOARD_MIKROE_NATIVE_CS_PIN 23U
#endif

#ifndef BOARD_MIKROE_NATIVE_RST_GPIO
#define BOARD_MIKROE_NATIVE_RST_GPIO GPIO1
#endif
#ifndef BOARD_MIKROE_NATIVE_RST_PIN
#define BOARD_MIKROE_NATIVE_RST_PIN 3U
#endif
...
//MIKROE NATIVE PIN INIT
#define MIKROE_NATIVE_PWM_INIT(output)   \
    GPIO_PinWrite(BOARD_MIKROE_NATIVE_PWM_GPIO, BOARD_MIKROE_NATIVE_PWM_PIN, 1); \
    GPIO3->PDDR |= (1U << BOARD_MIKROE_NATIVE_PWM_PIN);

#define MIKROE_NATIVE_CS_INIT(output)   \
    GPIO_PinWrite(BOARD_MIKROE_NATIVE_CS_GPIO, BOARD_MIKROE_NATIVE_CS_PIN, 1); \
    GPIO3->PDDR |= (1U << BOARD_MIKROE_NATIVE_CS_PIN);

#define MIKROE_NATIVE_RST_INIT()   \
    GPIO_PinWrite(BOARD_MIKROE_NATIVE_RST_GPIO, BOARD_MIKROE_NATIVE_RST_PIN, 1); \
    GPIO1->PDDR |= (1U << BOARD_MIKROE_NATIVE_RST_PIN);
